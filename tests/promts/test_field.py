...
from address_book.address_book_prompts import AddressPrompt, AdressBookPromptMessages, BirthdayPrompt, EditContactPrompt, EditNamePrompt, EditNewNamePrompt, EditNewPhonePrompt, EmailPrompt, NamePrompt, PhonePrompt, RemoveNamePrompt
...
def test_edit_contact_prompt_name(monkeypatch, mocker):
    ...
    mocker.patch('address_book.address_book_prompts.EditNewNamePrompt.field', new_callable=mocker.PropertyMock, return_value="John Doe")
...
def test_edit_contact_prompt_phone(monkeypatch, mocker):
    ...
    mocker.patch('address_book.address_book_prompts.EditNewPhonePrompt.field', new_callable=mocker.PropertyMock, return_value="0987654321")
    prompt = EditContactPrompt(break_cmd=None)
