...
def mock_prompts(mocker):
    mocker.patch('address_book.address_book_prompts.EditNamePrompt.__init__', lambda self: None)
    mocker.patch('address_book.address_book_prompts.EditNamePrompt.field', new_callable=mocker.PropertyMock, return_value="John Doe")
    mocker.patch('address_book.address_book_prompts.EditContactPrompt.__init__', lambda self, attribute=None: None)
    edit_contact_prompt_mock = mocker.patch('address_book.address_book_prompts.EditContactPrompt.field', new_callable=mocker.PropertyMock)
